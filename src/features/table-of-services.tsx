  ...
  return (
    <table className=" text-gray-60 bg-transparent w-full hidden sm:table table-fixed select-none">
      <thead className=" bg-black-6 text-white text-base md:text-xl font-semibold">
        <tr>
          <th className="border border-black-15 p-4 md:p-7 rounded-lg">
            Особливості
          </th>
          <th className="border border-black-15 p-4 md:p-7">Базовий</th>
          ...
          <th className="border border-black-15 p-4 md:p-7">Преміум</th>
        </tr>
      </thead>
